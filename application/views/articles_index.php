   ...
   <?php echo $this->pagination->create_links(); ?>
    ...
    <div class="am-u-md-4 am-u-sm-12 blog-sidebar">
        <div class="blog-sidebar-widget blog-bor">
            <h2 class="blog-text-center blog-title"><span>简介</span></h2>
            <img src="<?php echo base_url('/static/img/favicon.png')?>" alt="about me" class="blog-entry-img" >
            <p>诗画浙江</p>
            <p>一款大力弘扬“诗画浙江”品牌，力求全面建成中国最佳旅游目的地，浙江景区管理系统.</p>
        </div>
        <div class="blog-sidebar-widget blog-bor">
            <h2 class="blog-text-center blog-title"><span>Contact ME</span></h2>
            <p>
                <a href="tencent://message/?uin=416049355"><span class="am-icon-qq am-icon-fw am-primary blog-icon"></span></a>
                <a href="https://github.com/MetaphysicsWei/"><span class="am-icon-github am-icon-fw blog-icon"></span></a>
                <a href="http://weibo.com/"><span class="am-icon-weibo am-icon-fw blog-icon"></span></a>
        ...
        <div class="blog-sidebar-widget blog-bor">
            ...
            <ul class="am-list">
              <?php foreach ($friendship as $key => $value): ?>
                <li><a href="http://www.tourzj.gov.cn/play/vdestination_zixun.aspx" target="_blank">诗画浙江官网</a></li>
                <?php endforeach ;?>
            </ul>
        </div>
    </div>
