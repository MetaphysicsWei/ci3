...
<head>
  ...
  <meta name="author" content="https://github.com/MetaphysicsWei" />
...
<header class="am-g am-g-fixed blog-fixed blog-text-center blog-header">
    <div class="am-u-sm-8 am-u-sm-centered">
        <a href="<?php echo base_url()?>"><img width="200" src="<?php echo base_url('/static/img/ppzj.png')?>" alt="Startblog Logo"/></a>
