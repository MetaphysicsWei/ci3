    ...
    <div class="am-g tpl-g">
        ...
        <header>
            ...
            <div class="am-fl tpl-header-logo">
                <a href="<?php echo base_url('Articles/index')?>"><img src="<?php echo base_url('/static/admin/img/logoppzj.png')?>" alt="StartBlog"></a>
            </div>
            <!-- 右侧内容 -->
                ...
                <div class="am-fr tpl-header-navbar">
                    <ul>
                        ...
                        <li class="am-text-sm tpl-header-navbar-welcome">
                            <a href="https://github.com/MetaphysicsWei"><span class="am-icon-github"></span> </a>
                        </li>
                        <!-- 退出 -->
                        <li class="am-text-sm">
